 ...
 * 
 */
@WebServiceClient(name = "EpServiceService", targetNamespace = "http://webservice.export.tzs.cn/", wsdlLocation = "http://localhost:9080/jk_server/ws/export?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EPSERVICESERVICE_QNAME = new QName("http://webservice.export.tzs.cn/", "EpServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9080/jk_server/ws/export?wsdl");
    ...
    public IEpService getEpServicePort() {
        return super.getPort(new QName("http://webservice.export.tzs.cn/", "EpServicePort"), IEpService.class);
    }
    ...
    public IEpService getEpServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.export.tzs.cn/", "EpServicePort"), IEpService.class, features);
    }
