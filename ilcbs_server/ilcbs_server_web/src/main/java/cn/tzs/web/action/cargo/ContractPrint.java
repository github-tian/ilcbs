...
import cn.tzs.utils.file.PoiUtil;
...
public class ContractPrint {
     ...
     * 打印购销合同
     *
     * @param contract 要打印的合同对象
     * @param cpList   合同里面所有的货物礼盒
     * @param path      当前项目的路径
     * @param response
     * @throws Exception
     */
    public void print(Contract contract, List<ContractProduct> cpList, String path, HttpServletResponse response) throws Exception {
        //相同厂家的信息一起打印
